...
function About() {
  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.row}>
        <Body1>
          新酷音原是 Linux 系統下知名的輸入法，由 gugod, jserv, kanru
          等前輩，改良原本由龔律全與陳康本開發的酷音輸入法而來，有多種分支，目前已經能夠支援包括
          Mac 在內的多種平台。這個 Windows 版本是由 PCMan, czchen 等人，使用
          libchewing 核心，移植出 Windows TSF 版本。
        </Body1>
      </div>
